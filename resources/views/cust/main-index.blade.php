      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a  class="nav-link js-scroll-trigger" href="{{ route('register', ['user_type' => 'cust']) }}">Register</a>
            </li>
            @else
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{ route('all-questions')}}">My Questions</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger"  href="{{ route('register', ['user_type' => 'cust']) }}">{{ Auth::user()->name }}</a>
            </li>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h3 class="text-uppercase" style="color: rgba(240, 95, 65, 0.9); text-shadow: 2px -1px #000;">
              <strong>Have your Assignment done today!</strong>
            </h3>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5" style="background-color: rgba(192, 203, 217, 0.1); color: #ffa;text-shadow: 1px -1px #222; font-size: 20px;">Sign up today and have your assignment done, it takes a two step process and you are not charges till you accept the answer.  </p>
            
              @if(!Auth::check())
              <a class="btn btn-primary btn-xl js-scroll-trigger" href="{{ route('register', ['user_type' => 'cust']) }}">
