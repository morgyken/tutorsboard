...
<head>
  ...
  <title>Home-Assignment: Home</title>
  ...
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/web/assets/mobirise-icons-bold/mobirise-icons-bold.css')}}">
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/web/assets/mobirise-icons/mobirise-icons.css ')}}">
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/tether/tether.min.css ') }}">
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/bootstrap/css/bootstrap.min.css ') }}">
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/bootstrap/css/bootstrap-grid.min.css ') }}">
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/bootstrap/css/bootstrap-reboot.min.css ') }}">
  <link rel="stylesheet" href="{{ URL::asset('/theme1/landing/student/assets/dropdown/css/style.css') }}">
                ...
                <div class="col-md-12 align-center">
                    ...
                    <div class="icons-media-container mbr-white">
                        <div class="card col-12 col-md-6 col-lg-3">
                            ...
                            <h5 class="mbr-fonts-style display-5">Experienced Professionals</h5>
                        </div>
                        ...
                        <div class="card col-12 col-md-6 col-lg-3">
                            ...
                            <h5 class="mbr-fonts-style display-5">Creative Tutors</h5>
                        </div>
                        ...
                        <div class="card col-12 col-md-6 col-lg-3">
                            ...
                            <h5 class="mbr-fonts-style display-5">High Order Scrutiny for high Quaity</h5>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="header10 cid-qI84xrNWAT mbr-fullscreen mbr-parallax-background" id="header10-k">
    ...
    <div class="container">
        <div class="media-container-column mbr-white col-lg-8 col-md-10 ml-auto">
            <h1 class="mbr-section-title align-right mbr-bold pb-3 mbr-fonts-style display-1">Professional Advice&nbsp;</h1>
            <h3 class="mbr-section-subtitle align-right mbr-light pb-3 mbr-fonts-style display-2">We have experienced, dedicated and proficient Tutors</h3>
            ...
            <div class="mbr-section-btn align-right"><a class="btn btn-md btn-primary display-4" href="https://mobirise.com">Read More&nbsp;</a>
                <a class="btn btn-md btn-white-outline display-4" href="https://mobirise.com">Submit a Paper</a></div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="{{ URL::asset('/theme1/landing/student/assets/images/03.jpg')}}" alt="Mobirise">
                    </div>
                    <div class="card-box">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="align-center pb-2 mbr-fonts-style display-2">SUBSCRIPTIONS</h2>
                <h3 class="mbr-section-subtitle align-center pb-5 mbr-light mbr-fonts-style display-5">
                    Subscribe and uninterupted services, look at the following packages</h3>
            </div>
        </div>
        ...
        <div class="row py-2 justify-content-center">
            <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoid">
                ...
                <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="a84DIUsDWrO4RiSLSJmkUuyaoPaYslXyddRgPM8sJaiqaDamEzbxzZNLXBb8x2Uo3LOOrGWZV92OOrixkAtCTi7fehJPCr92n9/g1Tp51gZrA5SSajCXfdfvG52xpyM/" data-form-field="Email">
        ...
        <div class="media-container-row">
            <div class=" col-12 col-lg-4 col-md-6 my-2">
                <div class="pricing">
                    ...
                    <div class="plan-body">
                        <p class="mbr-text mbr-fonts-style display-7">Earn $150 worth of credit which you can use anytime during the semester. The subscrition is done weekly.&nbsp;</p>
                ...
                <div class="pricing">
                    <div class="plan-header">
                        <div class="plan-price">
                            ...
                            <h3 class="plan-title mbr-fonts-style display-5">Recommended</h3>
                            <hr>
                        </div>
                    </div>
                    <div class="plan-body">
                        <p class="mbr-text mbr-fonts-style display-7">This is the package used by many student, with this you earn $300 worth of credit to be used in asking the question. Choose this option and have access to asking questions any time without wory.&nbsp;</p>
                        <div class="mbr-section-btn pt-4 text-center">
                            <a href="https://mobirise.com" class="btn btn-primary display-4">BUY NOW</a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-4 col-md-6 my-2">
                <div class="pricing">
                    ...
                    <div class="plan-body ">
                        <p class="mbr-text mbr-fonts-style display-7">With the premium account, you have unlimited access to course materials, you have access to all features in the platform. Subscribe and enjoy.&nbsp;<br><br></p>
                        <div class="mbr-section-btn pt-4 text-center">
                            <a href="https://mobirise.com" class="btn btn-primary display-4">BUY NOW</a>
                        </div>
                    </div>
  ...
  <div class="container">
    ...
    <div class="testimonials-item">
        <div class="user row">
          <div class="col-lg-3 col-md-4">
            <div class="user_image">
              <img src="{{ URL::asset('/theme1/landing/tutor/assets/images/face3.jpg')}}">
            </div>
          </div>
        ...
        <div class="user row">
          <div class="col-lg-3 col-md-4">
            <div class="user_image">
              <img src="{{ URL::asset('/theme1/landing/student/assets/images/face1.jpg')}}">
            </div>
          </div>
          <div class="testimonials-caption col-lg-9 col-md-8">
            <div class="user_text">
